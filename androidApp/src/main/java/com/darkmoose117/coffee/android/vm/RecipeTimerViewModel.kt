...
import com.darkmoose117.coffee.usecase.IRecipeTimerUseCase
...
class RecipeTimerViewModel(
    ...
    private val getRecipeTimerUseCase: (Recipe) -> IRecipeTimerUseCase,
) : ViewModel() {
    private lateinit var timerUseCase: IRecipeTimerUseCase
